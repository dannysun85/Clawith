...
- These remain working-tree and isolated-runtime results until the branch is frozen and the exact-commit gates complete. They establish a local release candidate and one representative provider/browser business flow, but they do not establish a merged, tagged, deployed, all-media production-verified release. Historical RC3/RC4 evidence above remains evidence for those earlier candidates, not proof for this changed tree.
