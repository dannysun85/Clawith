...
const FALLBACK_LLM_PROVIDERS: LLMProviderSpec[] = [
    ...
    { provider: 'volcengine_agent_plan', display_name: 'Volcengine Agent Plan', protocol: 'anthropic', default_base_url: 'https://ark.cn-beijing.volces.com/api/plan', supports_tool_choice: false, default_max_tokens: 8192 },
