...
from app.models.group import Group  # noqa: F401 - registers the group_id FK target
from app.models.participant import Participant  # noqa: F401 - registers participant FK targets
...
class ChatSession(Base):
    ...
    __table_args__ = (
        ...
        Index(
            ...
            "user_id",
            unique=True,
            postgresql_where=text("session_type = 'direct' AND is_primary = true AND deleted_at IS NULL"),
        ),
        Index(
