...
BUILTIN_TOOLS = [
    ...
    },
    {
        ...
        "description": "Send a message to a digital employee colleague. Decision guide: target needs to DO WORK and return results? → task_delegate. Just FYI? → notify. Quick factual question? → consult. When unsure, prefer task_delegate. CEO coordinator task_delegate calls must include a verifiable delegation_contract.",
        "category": "communication",
        "icon": "🤖",
        "is_default": True,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "target_agent_id": {"type": "string", "description": "Stable target digital employee ID returned by query_directory"},
                "message": {"type": "string", "description": "Message content"},
                ...
                "delegation_contract": {
                    "type": "object",
                    "description": "Structured contract for verifiable task_delegate work.",
    ...
    },
    {
        ...
        "parameters_schema": {
            ...
            "properties": {
                ...
                "brand_asset": {"type": "string", "description": "Workspace image path or data URL composited as an immutable product/logo layer."},
