# Astra — Claude Code Instructions

This file provides guidance to Claude Code (claude.ai/code) when working in this repository. It is a **redirector only** and contains no substantive project knowledge.
...
Personal global rules (Karpathy 4 + Mnimiy 8) from `~/.claude/CLAUDE.md` also apply and are not duplicated here.
